    ...
    return (
        <div>
                ...
                <div className="mx-auto container px-6 lg:px-14 xl:px-0">
                    <div className="flex xl:flex-row flex-col justify-between items-start pt-16">
                        <div className="flex justify-center items-center xl:w-7/12">
                            <h1 className="xl:text-5xl text-4xl font-extrabold xl:leading-tight text-white xl:mt-8">System architecture and front-end development</h1>
                        </div>
                        <div className="w-full xl:-mr-8 xl:w-3/4 flex justify-end items-end xl:mt-6 mt-10 ">
                            <img className="w-full" src={"https://cdn.tuk.dev/assets/templates/portfolio/Dashboard.png"} alt="Dashboard" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="mx-auto container px-6 lg:px-14 xl:px-0">
                    <div className="grid xl:grid-cols-3 grid-cols-1 xl:justify-items-center py-12 gap-y-10 xl:gap-y-0">
                        <div className="flex justify-start items-start flex-col  ">
                            <div>
                                <p className="text-2xl font-bold lg:leading-6 text-white">Description</p>
                            </div>
                            <div className="mt-6">
                                <p className="text-base leading-normal text-gray-400">Front-end Architecture is a collection of tools and processes that aims to improve the quality of our front-end code while creating a more efficient and sustainable workflow. A Front-end developer's audience is the website user, a Front-end Architect's audience is the developer themselves.</p>
                            </div>
                            <div className="mt-8">
                                <button className="bg-white hover:text-gray-50 hover:bg-gray-800 focus:outline-none focus:ring-2  focus:ring-gray-400 text-gray-900 border rounded px-4 py-3 space-x-2 flex items-center justify-center flex-row ">
                                    ...
                                    <p className="text-base font-medium leading-none ">Go to repository</p>
                                </button>
                            </div>
                        </div>
                        <div className="flex justify-start items-start flex-col ">
                            <div>
                                <p className="text-2xl font-bold lg:leading-6 text-white">Client</p>
                            </div>
                            <div className="mt-6">
                                <p className="text-base leading-none text-white capitalize">Walker - O'Keefe</p>
                            </div>
                        </div>
                        <div className="flex justify-start items-start flex-col ">
                            <div>
                                <p className="text-2xl font-bold lg:leading-6 text-white">Year</p>
                            </div>
                            <div className="mt-6">
                                <p className="text-base leading-none text-white capitalize">July 2018 - June 2020</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div className="mx-auto container py-16 border-b border-gray-800 px-6 lg:px-14 xl:px-0">
                    <div className="flex justify-between items-start md:flex-row flex-col gap-y-10 xl:gap-y-0">
                        <div className="flex justify-start items-start flex-col">
                            <div>
                                <p className="text-2xl font-bold lg:leading-6 text-white">Technology stack</p>
                            </div>
                            <div className="grid grid-cols-2 mt-6 gap-x-6 gap-y-6">
                                <div>
                                    <p className="text-base leading-none text-white capitalize">HTML</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">CSS</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">Javascript</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">React</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">MongoDB</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">NodeJs</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex justify-start items-start flex-col">
                            <div>
                                <p className="text-2xl font-bold lg:leading-6 text-white">Infrastructure</p>
                            </div>
                            <div className="grid xl:grid-cols-4 sm:grid-cols-3 grid-cols-2 mt-6 gap-x-6 lg:gap-x-24 gap-y-6">
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS Elastic Beanstalk</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS SQS</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS SQS</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS Cloudfront</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS Lambda</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS DynamonDB</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS DynamonDB</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS CloufFormation</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS API Gateway</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS RDS</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">Route53</p>
                                </div>
                                <div>
                                    <p className="text-base leading-none text-white capitalize">AWS Elasticsearch</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="mx-auto container py-16 px-6 lg:px-14 xl:px-0">
                <div className="flex justify-start items-start flex-col">
                    <div>
                        <p className="text-2xl font-bold lg:leading-6 text-white">Summary</p>
                    </div>
                    <div className="ml-4 mt-8 xl:w-3/5">
                        <ul className="text-base  text-white list-disc xl:space-y-6 space-y-4  ">
                            <li>Used the strangler pattern to carry out the digital transformation of the legacy software system.</li>
                            <li>Successfully achieved the performance elevation of 70% on the front-end website.</li>
                            <li>Leveraged the client-side rendering (CSR) capabilities for ReactJS coupled with AWS Cloudfront distributions to ensure minimum latency at the client end.</li>
                            <li>Developed a custom CMS solution tailored for company needs including a highly interactive page builder.</li>
                            <li>Wrote serverless functions to keep the legacy/core database in sync with the cloud database while reducing the costs of renting and managing bare metal servers.</li>
                            <li>Leveraged messaging queues to distribute a workload of over 15 million database operations across a batch of serverless instances to ensure minimal data loss and reduced cost in terms of execution time per instance.</li>
                            <li>Set up CI/CD pipelines to ensure seamless deployments inside a Virtual Private Cloud (VPC).</li>
                            <li>Wrote 150 tests and implemented test automation using Jest and Puppeteer.</li>
                            <li>Reduced infrastructure deployment and maintenance costs by 70x.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-auto container px-6 lg:px-14 xl:px-0">
                    <div className="flex justify-center items-start flex-col ">
                        <div className="flex justify-start items-start pl-2 md:pl-6">
                            <h1 className="text-2xl font-extrabold leading-normal text-white">More Work</h1>
                        </div>
                        <div className="w-full items-center grid xl:grid-cols-4 md:grid-cols-3 grid-cols-2 xl:gap-x-6 xl:gap-y-6 gap-x-4 md:gap-x-6 mt-0 xl:mt-0 gap-y-4 md:gap-y-6">
                            <div className=" flex flex-col justify-between items-start p-3 md:p-6 bg-gray-800 rounded">
                                <div className="w-full">
                                    ...
                                    <div className="md:mt-4 mt-2">
                                        <p className=" text-base md:text-2xl font-semibold text-white">Building an Interactive Showcase with Vue.js & Vue InstantSearch </p>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <a onClick={() => router.push("/projectInner")}  className="cursor-pointer focus:outline-none focus:text-green-400 text-xs leading-3 hover:underline focus:underline text-gray-300">
                                        <p>Go to project</p>
                                    </a>
                                </div>
                            </div>
                            <div className=" flex flex-col justify-between items-start h-full p-3 md:p-6 bg-gray-800 rounded">
                                <div className="w-full">
                                    ...
                                    <div className="md:mt-4 mt-2">
                                        <p className=" text-base md:text-2xl font-semibold text-white">In Defense of Utility-First CSS</p>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <a onClick={() => router.push("/projectInner")}  className="cursor-pointer focus:outline-none focus:text-green-400 text-xs leading-3 hover:underline focus:underline text-gray-300">
                            ...
                            <div className=" flex flex-col h-full justify-between items-start p-3 md:p-6 bg-gray-800 rounded">
                                <div className="w-full">
                                    ...
                                    <div className="md:mt-4 mt-2">
                                        <p className=" text-base md:text-2xl font-semibold text-white">Why Javascript Numbers Are Weird (And How to Fix It)</p>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <a onClick={() => router.push("/projectInner")}  className="cursor-pointer focus:outline-none focus:text-green-400 text-xs leading-3 hover:underline focus:underline text-gray-300">
                            ...
                            <div className=" flex flex-col h-full justify-between items-start p-3 md:p-6 bg-gray-800 rounded">
                                <div className="w-full">
                                    ...
                                    <div className="md:mt-4 mt-2">
                                        <p className="xl:w-60 text-base md:text-2xl font-semibold text-white">Scalable Responsive Systems</p>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <a onClick={() => router.push("/projectInner")}  className="cursor-pointer focus:outline-none focus:text-green-400 text-xs leading-3 hover:underline focus:underline text-gray-300">
